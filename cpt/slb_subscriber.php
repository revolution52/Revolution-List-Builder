...
function slb_register_slb_subscriber() {
	...
	$labels = array(
		"name" => __( "Subscribers", "twentytwelve" ),
		"singular_name" => __( "Subscriber", "twentytwelve" ),
	);

	$args = array(
		"label" => __( "Subscribers", "twentytwelve" ),
		"labels" => $labels,
		"description" => "",
		"public" => false,
...
if( function_exists('acf_add_local_field_group') ):
  ...
  acf_add_local_field_group(array(
    'key' => 'group_5c23fb3e02c11',
    'title' => 'Subscriber Details',
    'fields' => array(
      array(
        'key' => 'field_5c23fb68b161f',
        'label' => 'First Name',
        'name' => 'slb_fname',
        'type' => 'text',
        'instructions' => '',
